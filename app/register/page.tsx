    ...
    <>
      ...
      <section className="page-title">
        <div className="auto-container pb-5">
          ...
          <p className="text-center">Join our educational community today</p>
        </div>
      </section>
        ...
        <div className="auto-container">
          <div className="register-box shadow-sm rounded-3">
            <div className="title-box text-center mb-4">
              <div className="text">
                <span className="theme_color">Welcome to EduPortal!</span> Please fill in your details to get started
              </div>
            </div>
                ...
                <div className="row clearfix">
                  <div className="form-group col-lg-12 col-md-12 col-sm-12 position-relative mb-4">
                    ...
                    <div className="position-relative">
                      <select
                        name="role"
                        className={`form-select pe-5 ${errors.role ? "is-invalid" : ""}`}
                        value={formData.role || ""}
                        onChange={(e) => {
                  ...
                  <div className="row">
                    ...
                    <div className="form-group col-lg-6 col-md-6 col-sm-12 mb-4">
                      <div>
                        <label className="form-label fw-bold mb-2">Confirm Password</label>{" "}
                        <span className="text-danger">*</span>
                      </div>
                      <div className="position-relative">
                        <input
                  ...
                  <div className="form-group col-lg-12 col-md-12 col-sm-12 mb-4">
                    <label className="form-label fw-bold mb-2">Bio (Optional)</label>
                    <textarea
                  ...
                  <div className="form-group col-lg-12 col-md-12 col-sm-12 mb-4">
                    <label className="form-label fw-bold mb-2">Profile Picture (Optional)</label>
                    <input
                      type="file"
                      name="avatar"
                      accept="image/*"
                  ...
                  <div className=" col-lg-12 col-md-12 col-sm-12 mb-4 ml-4">
                    <div className="gendar-chec">
                      <input
                        ...
                        onChange={handleChange}
                      />
                      <label className="form-check-label" htmlFor="type-4" style={{marginLeft: "30px"}}>
                        I agree to the{" "}
                  ...
                  <div className="form-group col-lg-12 col-md-12 col-sm-12 text-center mb-4">
                    <button type="submit" className="theme-btn btn-style-three w-100 py-3" disabled={isSubmitting}>
                      <span className="txt">
...
//             <h2>Welcome!</h2>
//             <p>Please confirm that you are visiting</p>
//           </div>
...
//                     onChange={handleChange}
//                   />
//                   <span className="gender-label">Others</span>
//                 </label>
//               </div>
...
//               {!isSubmitting && <FaAngleRight className="btn-icon" />}
//             </button>
